...
export default function HowItWorks() {
  return (
    <>
      <SEO title="Jak to działa" description="Dowiedz sie, jak dzialaja nasze porownania i rekomendacje kosmetykow do wlosow." />
      <Header />
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Analizujemy składy INCI produktow do pielegnacji wlosow dostepnych na polskim rynku.
              Kazdy produkt jest kategoryzowany wedlug typu wlosow, problemow i składników aktywnych.
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              wedlug składników, ktorych chcesz unikac.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              i składniki, ktorych chcesz unikac. Wynik dopasowania jest wyswietlany jako
